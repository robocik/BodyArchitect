...
namespace BodyArchitect.UnitTests
{
    ...
    public class TestService_ExerciseMapper:TestServiceBase
    {
        ...
        public void TestMapExercises_GlobalToPrivate()
        {
            ...
            Assert.AreEqual(4, Session.QueryOver<StrengthTrainingItem>().Where(x => x.ExerciseId == exercises["t4"].GlobalId).RowCount());
            Assert.AreEqual(1, Session.QueryOver<StrengthTrainingItem>().Where(x => x.ExerciseId == exercises["t3"].GlobalId).RowCount());
            Assert.AreEqual(0, Session.QueryOver<StrengthTrainingItem>().Where(x => x.ExerciseId == exercises["t1"].GlobalId).RowCount());
        }
        ...
        public void TestMapExercises_TwoExercisesToMap()
        {
            ...
            Assert.AreEqual(0, Session.QueryOver<StrengthTrainingItem>().Where(x => x.ExerciseId == exercises["t4"].GlobalId).RowCount());
            Assert.AreEqual(0, Session.QueryOver<StrengthTrainingItem>().Where(x => x.ExerciseId == exercises["t3"].GlobalId).RowCount());
            Assert.AreEqual(4, Session.QueryOver<StrengthTrainingItem>().Where(x => x.ExerciseId == exercises["t1"].GlobalId).RowCount());
