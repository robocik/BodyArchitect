...
//            CustomApplicationService.Current.State[_HistoryStateKey] = _History;
//        }
//        #endregion
...
//                    // flag to be used by the CustomNavigationPage.OnNavigatedTo
...
//        {
//            if (CustomApplicationService.Current.State.ContainsKey(_HistoryStateKey))
//            {
//                return (List<Uri>)CustomApplicationService.Current.State[_HistoryStateKey];
//            }
//            else
//            {
//                var h = new List<Uri>();
//                CustomApplicationService.Current.State.Add(_HistoryStateKey, h);
//                return h;
//            }
//        }
//        #endregion
