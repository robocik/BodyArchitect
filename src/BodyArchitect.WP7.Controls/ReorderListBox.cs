...
namespace BodyArchitect.WP7.Controls
{
    ...
    public class ReorderListBox : ListBox
    {
        ...
        public event EventHandler<ListReorderedEventArgs> ListReordered;
        public event EventHandler<CancelEventArgs> ListReordering;
        ...
        private bool MoveItem(object item, int toIndex)
        {
            ...
            if (fromIndex != toIndex)
            {
                ...
                {
                    ListReordered(this,new ListReorderedEventArgs(fromIndex,toIndex,item));
                }
                return true;
            }
            else
