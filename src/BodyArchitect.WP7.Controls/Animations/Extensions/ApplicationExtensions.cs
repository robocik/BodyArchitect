...
namespace Clarity.Phone.Extensions
{
    ...
    {
        private static readonly string CustomLightThemeVisibility = "CustomLightThemeVisibility";
        ...
        {
            var visibility = (Visibility)Application.Current.Resources[CustomLightThemeVisibility];
