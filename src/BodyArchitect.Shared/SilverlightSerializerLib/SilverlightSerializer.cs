...
namespace BodyArchitect.Shared
{
    ...
    public static class SilverlightSerializer
    {
        ...
        {
            return tp.IsPrimitive || tp == typeof(DateTime) || tp == typeof(TimeSpan) || tp == typeof(string) || tp.IsEnum || tp == typeof(Guid) 
                || tp == typeof(decimal) || tp==typeof(Color);
        }
        ...
        static SilverlightSerializer()
        {
            ...
            Writers[typeof(Color)] = ColorWriter;
            ...
            Readers[typeof(Color)] = ColorReader;
        ...
        private static object ColorReader(BinaryReader reader)
        {
        ...
        private static void ColorWriter(BinaryWriter writer, object value)
        {
