...
namespace BodyArchitect.Client.Module.Blog
{
    ...
    public class ImageAlignment : OptionObject
    {
        ...
        public static readonly ImageAlignment Default =
            new ImageAlignment { Text = BlogEntryStrings.Align_Default, Value = "" };

        public static readonly ImageAlignment Left = 
            new ImageAlignment { Text = BlogEntryStrings.Align_Left, Value = "left" };

        public static readonly ImageAlignment Right = 
            new ImageAlignment { Text = BlogEntryStrings.Align_Right, Value = "right" };

        public static readonly ImageAlignment Top = 
            new ImageAlignment { Text = BlogEntryStrings.Align_Top, Value = "top" };

        public static readonly ImageAlignment Center = 
            new ImageAlignment { Text = BlogEntryStrings.Align_Center, Value = "center" };

        public static readonly ImageAlignment Bottom = 
            new ImageAlignment { Text = BlogEntryStrings.Align_Bottom, Value = "bottom" };
    }
    ...
    public class TableHeaderOption : OptionObject
    {
        ...
        public static readonly TableHeaderOption Default =
            new TableHeaderOption { Text = BlogEntryStrings.Header_Default, Value = "Default" };

        public static readonly TableHeaderOption FirstRow =
            new TableHeaderOption { Text = BlogEntryStrings.Header_FirstRow, Value = "FirstRow" };

        public static readonly TableHeaderOption FirstColumn =
            new TableHeaderOption { Text = BlogEntryStrings.Header_FirstColumn, Value = "FirstColumn" };

        public static readonly TableHeaderOption FirstRowAndColumn =
            new TableHeaderOption { Text = BlogEntryStrings.Header_FirstRowAndColumn, Value = "FirstRowAndColumn" };
    }
    ...
    public class TableAlignment : OptionObject
    {
        ...
        public static readonly TableAlignment Default = 
            new TableAlignment { Text = BlogEntryStrings.Align_Default, Value = "" };

        public static readonly TableAlignment Center = 
            new TableAlignment { Text = BlogEntryStrings.Align_Center, Value = "center" };

        public static readonly TableAlignment Left = 
            new TableAlignment { Text = BlogEntryStrings.Align_Left, Value = "left" };

        public static readonly TableAlignment Right = 
            new TableAlignment { Text = BlogEntryStrings.Align_Right, Value = "right" };        
    }
