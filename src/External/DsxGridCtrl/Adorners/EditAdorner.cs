...
namespace DsxGridCtrl
{
    public class EditAdorner : Adorner
    {
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            Pen     _renderPen          = new Pen(_borderBrush, 1);
            double  _renderRadius       = 1.0;
            Rect    _adornedElementRect = new Rect(this.AdornedElement.RenderSize);

            drawingContext.DrawRoundedRectangle((Brush) Application.Current.Resources["NormalBrush"], _renderPen, _adornedElementRect, _renderRadius, _renderRadius);
        ...
        private void InitEditing(FrameworkElement gridViewCell)
        {
            ...
            this.EditPanel.Background = (Brush) Application.Current.Resources["NormalBrush"];
            ...
            switch(_editType)
            {
                ...
                case EEditType.DatePicker:
                    ...
                    _datePicker.CalendarStyle = (Style) Application.Current.Resources[typeof(Calendar)];
                                        _datePicker.FocusVisualStyle = null;
                                        _datePicker.Margin           = new Thickness(0);
                                        _datePicker.Padding          = new Thickness(0);
                                        _datePicker.Background = (Brush) Application.Current.Resources["NormalBrush"];
                ...
                case EEditType.ComboBox:
                    ...
                    DsxCellComboBox     _comboBox                   = new DsxCellComboBox();
                                        ...
                                        _comboBox.Background = (Brush)Application.Current.Resources["NormalBrush"];
                                        _comboBox.BorderThickness   = new Thickness(0);

                                        _comboBox.IsTextSearchEnabled = true;
                                        _comboBox.IsEditable          = false;

                                        _comboBox.SelectedValuePath = this.Column.CellContentSelectedValuePath;
                ...
                case EEditType.Slider:
                    ...
                    DsxCellSlider       _sliderCtrl                   = new DsxCellSlider();
                                        ...
                                        _sliderCtrl.Background = (Brush)Application.Current.Resources["NormalBrush"];
