...
namespace DsxGridCtrl
{
    ...
    public class DsxColumn : GridViewColumn
    {
        ...
        public DsxColumn(GridViewColumn gridViewColumn, DsxDataGrid DataGrid)
        {
            ...
            if (_gridViewColumn != null )
            {
                ...
                this.Converter = _gridViewColumn.Converter;
                ...
                this.CellContentDisplayMemberPath = _gridViewColumn.CellContentDisplayMemberPath;
                this.CellContentSelectedValuePath = _gridViewColumn.CellContentSelectedValuePath;
        ...
        private void InitViewDisplay()
        {
            ...
            if (this.CellTemplate == null)
            {
                ...
                else
                {
                    ...
                    _singleBinding.Converter = this.Converter;
        ...
        #region DP - CellContentDisplayMemberPath

        public static readonly DependencyProperty CellContentDisplayMemberPathProperty =
            DependencyProperty.Register("CellContentDisplayMemberPath", typeof(string), typeof(DsxColumn), new PropertyMetadata(null));

        public string CellContentDisplayMemberPath
        {
            get { return (string)GetValue(CellContentDisplayMemberPathProperty); }
            set { SetValue(CellContentDisplayMemberPathProperty, value); }
        }
        #endregion

        #region DP - CellContentSelectedValuePath

        public static readonly DependencyProperty CellContentSelectedValuePathProperty =
            DependencyProperty.Register("CellContentSelectedValuePath", typeof(string), typeof(DsxColumn), new PropertyMetadata(null));

        public string CellContentSelectedValuePath
        {
            get { return (string)GetValue(CellContentSelectedValuePathProperty); }
            set { SetValue(CellContentSelectedValuePathProperty, value); }
        }
        #endregion
        ...
        public static readonly DependencyProperty ConverterProperty =
            DependencyProperty.Register("Converter", typeof(IValueConverter), typeof(DsxColumn), new PropertyMetadata(null));
    ...
    public class PropertyReflector
    {
        ...
        public PropertyInfo GetProperty(string fieldName, BindingFlags bindingFlags)
        {
