...
{
	public class DragDropListHelper
	{
		// source and target
		...
		// singleton
        private static DragDropListHelper instance;
        private static DragDropListHelper Instance 
		{
			get 
			{  
				if(instance == null)
				{
                    instance = new DragDropListHelper();
				}
				return instance;
			}
		}
		...
		public static readonly DependencyProperty IsDragSourceProperty =
			DependencyProperty.RegisterAttached("IsDragSource", typeof(bool), typeof(DragDropListHelper), new UIPropertyMetadata(false, IsDragSourceChanged));
		...
		public static readonly DependencyProperty IsDropTargetProperty =
            DependencyProperty.RegisterAttached("IsDropTarget", typeof(bool), typeof(DragDropListHelper), new UIPropertyMetadata(false, IsDropTargetChanged));
		...
		public static readonly DependencyProperty DragDropTemplateProperty =
			DependencyProperty.RegisterAttached("DragDropTemplate", typeof(DataTemplate), typeof(DragDropListHelper), new UIPropertyMetadata(null));
