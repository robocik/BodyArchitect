...
namespace BodyArchitect.Client.UI.Controls.Accordion.System
{
    /// <summary>
    ...
    public class TransitioningContentControl : ContentControl
    {
            ...
            if (newStoryboard == null)
            {
                ...
                else
                {
                    ...
                    throw new ArgumentException(
                        string.Format(CultureInfo.CurrentCulture, "TransitioningContentControl_TransitionNotFound, newTransition"));
                }
            }
            else
            {
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (transition == null)
            {
                ...
                throw new ArgumentException(
                    string.Format(CultureInfo.CurrentCulture, "TransitioningContentControl_TransitionNotFound", invalidTransition));
            }
