...
namespace BodyArchitect.Service.Model
{
    ...
    public class TrainingDayDTO : BAObject
    {
        ...
        public TrainingDayDTO(DateTime trainingDate, int profileId)
            : this()
        {
        ...
        public EntryObjectDTO GetEntryObject(int id)
        {
            return (from o in Objects where o.Id == id select o).SingleOrDefault();
        }
