...
namespace Orchard.BodyArchitect.Controllers {
    [HandleError, Themed]
    public class AccountController : Controller {
        ...
        public ActionResult Register() {
            ...
            ViewData["Countries"] = new SelectList(Models.Country.Countries, "GeoId", "DisplayName", Models.Country.Countries.First().GeoId); // this has a value;
        ...
        public ActionResult Register(string userName, string email, string password, string confirmPassword,int country) {
            ...
            ViewData["PasswordLength"] = MinPasswordLength;
            ViewData["Countries"] = new SelectList(Models.Country.Countries, "GeoId", "DisplayName", country); // this has a value;
            ...
            if (ValidateRegistration(userName, email, password, confirmPassword)) {
                ...
                try
                {
                    var user = _membershipService.CreateUser(new BACreateUserParams(userName, password, email, null, null, false, country));
                    ...
                    if (user != null)
                    {
                        ...
                        //    _userService.SendChallengeEmail(user.As<UserPart>(), nonce => Url.MakeAbsolute(Url.Action("ChallengeEmail", "Account", new { Area = "Orchard.BodyArchitect", nonce = nonce }), siteUrl));
                ...
                catch (Exception)
                {
                    ...
                    //T("User with that username and/or email already exists."
                    ModelState.AddModelError("_FORM", T(ErrorCodeToString(/*createStatus*/MembershipCreateStatus.ProviderError)));
                }
        ...
        public ActionResult RequestLostPassword(string username) {
            ...
            _userService.SendLostPasswordEmail(username, nonce => Url.MakeAbsolute(Url.Action("LostPassword", "Account", new { Area = "Orchard.BodyArchitect", nonce = nonce }), siteUrl));
