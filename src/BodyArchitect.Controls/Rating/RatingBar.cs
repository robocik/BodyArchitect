...
namespace BodyArchitect.Controls
{
    ...
    public class RatingBar : Control
    {
        ...
        public RatingBar()
        {
            ...
            BackColor = Constants.PanelBackColor;
            BarBackColor = Constants.PanelBackColor;
            UpdateIcons();
            UpdateBarSize();
        ...
        void UpdateIcons()
        {
            ...
            {
                iconEmpty = Icons.iconStarEmpty;
                iconFull = Icons.iconStarFull;
                iconHalf = Icons.iconStartHalf;
            }
            else if (iconStyle == IconStyle.Heart)
            {
                iconEmpty = Icons.iconHeartEmpty;
                iconFull = Icons.iconHeartFull;
                iconHalf = Icons.iconHeartHalf;
            }
            else if (iconStyle == IconStyle.Misc)
            {
                iconEmpty = Icons.iconMiscEmpty;
                iconFull = Icons.iconMiscFull;
                iconHalf = Icons.iconMiscHalf;
            }
        }
        #endregion
