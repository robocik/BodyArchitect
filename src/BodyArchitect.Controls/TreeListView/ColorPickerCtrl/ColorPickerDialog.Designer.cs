namespace BodyArchitect.Controls.External
{
	partial class ColorPickerDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_colorList = new BodyArchitect.Controls.External.ColorListBox();
			this.m_systemColorsTabPage = new System.Windows.Forms.TabPage();
			this.m_systemColorList = new BodyArchitect.Controls.External.SystemColorListBox();
		...
		private BodyArchitect.Controls.External.ColorListBox m_colorList;
		private BodyArchitect.Controls.External.SystemColorListBox m_systemColorList;
	}
}
