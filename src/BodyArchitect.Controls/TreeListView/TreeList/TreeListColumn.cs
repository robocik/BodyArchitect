...
namespace BodyArchitect.Controls.External
{
	...
	public class TreeListColumnCollection : IList<TreeListColumn>, IList
	{
		...
		public void RecalcVisibleColumsRect(bool isDoingColumnResizing)
		{
			...
			/*
			BodyArchitect.Controls.External.Tracing.WriteLine(0, "\nRecalcVisibleColumsRect");
			BodyArchitect.Controls.External.Tracing.WriteLine(0, "WidthRequired, auto {0}, fixed {1}, total {2}", 
			...
			*/
			...
			/*
			BodyArchitect.Controls.External.Tracing.WriteLine(0, "ClientWidth {0}", clientWidth);
			BodyArchitect.Controls.External.Tracing.WriteLine(0, "RemainngWidth {0}, TotalRatio {1},  RatioUnits {2}", 
				remainingWidth,
				totalRatio,
				ratioUnit);
			*/
