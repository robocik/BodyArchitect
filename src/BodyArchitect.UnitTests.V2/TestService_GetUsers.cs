...
namespace BodyArchitect.UnitTests.V2
{
    ...
    public class TestService_GetUsers:TestServiceBase
    {
        ...
        [Test]
        public void TestUserByProfileId()
        {
            var criteria = UserSearchCriteria.CreateAllCriteria();
            criteria.ProfileId = profiles[1].GlobalId;
        ...
        [Test]
        public void TestUserByProfileId_NonSearchable()
        {
            var criteria = UserSearchCriteria.CreateAllCriteria();
            criteria.ProfileId = profiles[12].GlobalId;
        ...
        [Test]
        public void TestUserByName_Like()
        {
            var criteria = UserSearchCriteria.CreateAllCriteria();
            criteria.UserName = "Profile1";
            ...
            assertUsersResult(result, 3, "Profile10", "Profile11", "Profile12");
        }
        ...
        {
            var criteria = UserSearchCriteria.CreateAllCriteria();
            criteria.Genders.Add(Service.V2.Model.Gender.Female);
        ...
        {
            var criteria = UserSearchCriteria.CreateAllCriteria();
            criteria.WorkoutPlan = UserPlanCriteria.OnlyWithPlans;
        ...
        public void TestIsOnline()
        {
            ...
            Assert.IsTrue(result.Items[0].IsOnline);
        }
