...
{
    [TestFixture]
    public class TestPremiumAccount : TestServiceBase
    {
        ...
        public override void BuildDatabase()
        {
            ...
            {
                profiles.Clear();
                profiles.Add(CreateProfile(Session, "test1", accountType: AccountType.PremiumUser));
                profiles.Add(CreateProfile(Session, "test2", accountType: AccountType.PremiumUser));
                profiles.Add(CreateProfile(Session, "test3", accountType: AccountType.PremiumUser));
        ...
        public void DeleteWorkoutPlan()
        {
            ...
            {
                var securityInfo = SecurityManager.EnsureAuthentication(data.Token);
                securityInfo.Licence.CurrentAccountType = BodyArchitect.Service.V2.Model.AccountType.PremiumUser;
