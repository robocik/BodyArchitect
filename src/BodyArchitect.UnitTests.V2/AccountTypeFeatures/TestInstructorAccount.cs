...
{
    [TestFixture]
    public class TestInstructorAccount:TestServiceBase
    {
        ...
        public override void BuildDatabase()
        {
            ...
            {
                profiles.Clear();
                profiles.Add(CreateProfile(Session, "test1", accountType: AccountType.Instructor));
                profiles.Add(CreateProfile(Session, "test2", accountType: AccountType.Instructor));
                profiles.Add(CreateProfile(Session, "test3", accountType: AccountType.Instructor));
        ...
        public void DeleteWorkoutPlan()
        {
            ...
            {
                var securityInfo = SecurityManager.EnsureAuthentication(data.Token);
                securityInfo.Licence.CurrentAccountType = BodyArchitect.Service.V2.Model.AccountType.Instructor;
