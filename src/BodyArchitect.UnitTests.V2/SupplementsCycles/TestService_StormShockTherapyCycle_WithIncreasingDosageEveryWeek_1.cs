...
{
    [TestFixture]
    public class TestService_StormShockTherapyCycle_WithIncreasingDosageEveryWeek_1 : TestServiceBase
    {
        ...
        private SupplementCycleDefinition createCreatingStormAndShockTherapy_InsreaseServingsEveryWeekDefinition()
        {
            ...
            dosageDto.Dosage = 1;
            dosageDto.DosageType = Service.V2.Model.DosageType.Servings;
